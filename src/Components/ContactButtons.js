...
function ContactButtons() {
    ...
    return (
        <div className="contacts">
            <a href="https://github.com/KiichiKatsu" target="_blank" rel="noopener noreferrer">
                <img src={GitHubIcon} className="ContactImg" alt="My GitHub"/>
            </a>
            <a href="https://www.linkedin.com/in/kiichiro-tatsuzawa-11511b296" target="_blank" rel="noopener noreferrer">
