// ORCID has no lucide glyph, so this is a small inline mark that matches the
// stroke weight of the lucide icons used elsewhere.
export default function OrcidIcon({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
